...
public class BigQueryIntegration {
	...
	private static final Logger LOG = LoggerFactory.getLogger(BigQueryIntegration.class);
	...
	private static void writeToBigQuery(PCollection<TableRow> records) {
		String tableSpec = "transactions.transaction_details";
		...
		records.apply(BigQueryIO.writeTableRows().to(tableSpec).withSchema(tableSchema)
